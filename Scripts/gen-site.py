...
.hero {
  ...
  align-items: center;
  padding-block: clamp(48px, 6vw, 84px) clamp(48px, 6vw, 76px);
}
...
def build_index():
    title = "Zenithium — Toparlanma, Uyku ve Antrenman"
    desc = "Apple Watch kayıtlarından toparlanma, uyku ve antrenman özeti. Açık hesaplar, cihaz içi tahlil okuma ve sana ait veriler."
    url = "https://projectcagla.github.io/zenithium/"

    content = """
<div class="hero-band"><div class="wrap hero">
  <div class="hero-copy">
    <span class="eyebrow">Sürüm 1.1 · iPhone · Apple Watch · Türkçe</span>
    <h1>Günün ritmini anla.<br><em>Kararının nedenini gör.</em></h1>
    <p class="lede">Uyku, toparlanma ve antrenman kayıtlarını aynı yerde gör. Bugünkü skorun neden değiştiğini incele; ölçümlerini, kişisel tabanını ve hesabın sınırlarını takip et. Yeterli veri olmadığında Zenithium bunu açıkça söyler.</p>
    <div class="hero-cta">
      <a class="btn solid" href="#karar">Nasıl Karar Veriyor?</a>
      <a class="btn" href="https://github.com/projectcagla/zenithium">Kaynak Kodu</a>
    </div>
    <div class="manifest">
      <div class="mhead">Veri sana ait</div>
      <div class="mrow"><span class="x">✕</span><span class="lab">Uygulamada ağ isteği</span><span class="st">Yok</span></div>
      ...
      <p class="foot">Uygulamaya ait sunucu veya hesap yoktur. Apple Sağlık ve Watch eşitlemesi sistem hizmetleriyle çalışır. Arşivini yalnızca sen paylaşmayı seçtiğinde dışa aktarırsın.</p>
    </div>
  </div>

  <figure class="art" style="margin:0; display:grid; justify-items:center; gap:12px;">
    <img src="qa/phase3/bugun-dolu.png" alt="Zenithium 1.1: toparlanma, kayıtlı ölçümler ve günlük plan" width="402" height="874" style="width:min(100%,350px); height:auto; border:1px solid var(--hairline); border-radius:32px;" />
    <figcaption style="font-size:0.75rem; color:var(--dim);">Uygulamadan görünüm · örnek kayıtlar</figcaption>
  </figure>
</div></div>

<!-- Kullanıcıya açık temel kapsam -->
<div class="wrap">
  <div class="counts">
    <div><span class="v">30</span><span class="k">Hesap Modülü</span><span class="s">Cihazda yerel çalışır</span></div>
    <div><span class="v">16</span><span class="k">Kas Grubu</span><span class="s">Kayıt temelli yük modeli</span></div>
    <div><span class="v">50</span><span class="k">Biyobelirteç</span><span class="s">Laboratuvar referans eşleşmesi</span></div>
    <div><span class="v">14<i> gün</i></span><span class="k">Taban Çizgisi</span><span class="s">Geçerli gece örnekleri</span></div>
  </div>
</div>
...
<main class="wrap">
  ...
  <section id="merdiven">
    ...
    <div class="ladder">
      <div class="ladder-step">
        ...
        <p>Apple Sağlık’taki SDNN kaydı. Sensör ve örnekleme koşulları ölçümü etkileyebilir.</p>
      ...
      <div class="ladder-step">
        ...
        <p>Ölçümler, kayıt geçmişi ve planlama tercihinden üretilen öneri. Kaynaklar yöntemin dayanağını ve sınırlarını açıklar.</p>
        <span class="claim-strength">Kaynaklı yöntem · ürünün planlama kuralı</span>
      </div>
    </div>
  </section>
  ...
  <section id="uyku">
    <div class="sec-head">
      ...
      <h2>Geceyi, kaydedildiği gibi gör.</h2>
      <p>Uyumlu saat ve yeterli kayıt olduğunda HRV, dinlenme nabzı, bilek sıcaklığı ve solunum hızı birlikte incelenir. Hangi sinyalin eksik olduğu ve kişisel tabanın ne kadar oluştuğu görünür.</p>
    </div>
    ...
    <div class="showcase">
      ...
      <div class="prose">
        <h3>Tabanın gece gece oluşur.</h3>
        <p>Taban çizgin oturana kadar Zenithium skor uydurmaz. İlk 14 gecede hangi ölçümlerin toplandığını ve kişisel karar için kaç gece kaldığını açıkça gösterir.</p>
        <p>Saatini takmadan uyuduğun bir gecenin ardından da uydurmaz: o sabah skor yerine hangi sinyalin eksik olduğunu yazar. Eksik veriyle üretilen bir sayı göstermenin sınırları bu ekranda belirtilir.</p>
        <div style="display:grid; gap:12px; margin-top:8px;">
          <div style="border-left:2px solid var(--accent); padding-left:14px;">
            <strong style="color:var(--text); font-size:0.92rem;">Evrelerin özgün zamanları korunur.</strong>
            <p style="font-size:0.85rem; color:var(--dim); margin-top:2px;">Derin, REM ve hafif uyku aralıkları Apple Sağlık kayıtlarından okunur. Saatin evre sınıflandırması bir tahmindir; uyku laboratuvarı ölçümünün yerine geçmez.</p>
          </div>
          <div style="border-left:2px solid var(--moderate); padding-left:14px;">
            <strong style="color:var(--text); font-size:0.92rem;">Uyku planın geçmişini dikkate alır.</strong>
            <p style="font-size:0.85rem; color:var(--dim); margin-top:2px;">Hedef süre ile kaydedilen uyku arasındaki fark birkaç gecelik planlamada kullanılır. Hesaplanan ihtiyaç kişisel bir planlama tahminidir.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="karar">
    <div class="sec-head">
      ...
      <h2>Dünden bugüne ne değişti?</h2>
      <p>HRV, dinlenme nabzı, uyku ve diğer ölçümlerin puan değişimine katkısını ayrı gör. Kişisel tabanın güncellenmesinden gelen fark da ayrılır. Bu, hesabın açıklamasıdır; biyolojik nedenlerin kanıtı değildir.</p>
    </div>
    ...
    <div class="showcase reverse">
          ...
          <div class="frame"><div class="island"></div><div class="screen">
            ...
            <div class="trace-chain">
              ...
              <div class="trace-step">
                ...
                <div class="trace-info">
                  <div class="trace-title-row"><span>Katkı ve Ağırlık</span><span class="trace-badge">Ölçüme göre</span></div>
                  <div class="trace-detail">Sürücü ağırlıkları ve eksik ölçümler görünür</div>
                </div>
              </div>
              <div class="trace-step">
                ...
                <div class="trace-info">
                  ...
                  <div class="trace-detail">Toparlanma ve seçtiğin planlama tercihi birlikte değerlendirilir</div>
                </div>
              </div>
              <div class="trace-step">
              ...
              <div class="trace-step">
                ...
                <div class="trace-info">
                  <div class="trace-title-row"><span>Veri kapsamı</span><span class="trace-badge">Açık hesap</span></div>
                  <div class="trace-detail">Kapsam katsayısı doğruluk olasılığı değildir</div>
                </div>
              </div>
              <div class="trace-step">
      ...
      <div class="prose">
        <h3>Skorun arkasındaki hesabı gör.</h3>
        <p>Toparlanma puanı tek başına bütün hikâyeyi anlatmaz. Ölçümleri, kişisel tabanı ve eksik kayıtları birlikte inceleyebilirsin.</p>
        <p><strong>“Bu kararın nedeni”</strong> bağlantısı hesap adımlarını açar. Ayrıntılarda dünden bugüne puan farkını ölçüm katkıları ve taban değişimiyle birlikte görürsün. Kaynak kartları, araştırmanın neyi göstermediğini de açıklar.</p>
        <p>Karar yeni ölçümler ve etkin kişisel bağlamınla yeniden hesaplanır. Bu matematik izi fizyolojik neden-sonuç kanıtı değildir. Yan taraftaki akış örnek anlatımdır.</p>
      </div>
    </div>
  </section>
  ...
  <section id="kas-tahlil">
    <div class="sec-head">
      ...
      <p>Egzersizlerini set, tekrar, zorluk ve isteğe bağlı ağırlıkla kaydet. Hacim ve tahmini 1TM geçmişini izle. 16 kas grubundaki yorgunluk görünümü bir modeldir; ölçülmüş kas hasarı değildir.</p>
    </div>
    ...
    <div class="showcase">
      ...
      <div class="prose">
        <h3>Tahlil geçmişin elinin altında.</h3>
        <p>PDF veya fotoğrafını içe aktar, cihazda okunan her satırı kontrol et ve onayla. İstersen ölçümü elle de ekleyebilirsin. Belgenin aslı ve ölçüm geçmişi cihazında kalır.</p>
        <p>Raporda varsa laboratuvar referans aralığı gösterilir; yoksa aralık uydurulmaz. Antrenman ile ölçüm arasındaki zaman yakınlığı görülebilir, ancak antrenmanın sonucu değiştirdiği iddia edilmez. Klinik değerlendirme hekime aittir.</p>
  ...
  <section id="saat-sinirlar">
    <div class="sec-head">
      <span class="eyebrow">Apple Watch</span>
      <h2>Bileğinde bağırmayan bir gösterge.</h2>
      <p>Toparlanma ve kararını saat kadranında veya Smart Stack içinde gör. Antrenmanda set kaydet; telefon yanında olmasa da kayıt saatte kalır ve bağlantı kurulduğunda eşitlenir.</p>
    </div>
    ...
    <div class="showcase">
      ...
      <div class="prose">
        <h3>Tercihlerin günlük plana yansır.</h3>
        <p>Geçici koşullarını kaydet, hatırlatıcıları seç ve kendi arşivini yönet. Ayarlar yalnızca görünümü değiştirmez; kullandığın plana da yansır.</p>
        <ul style="list-style:none; padding:0; margin:0; display:grid; gap:8px; font-size:0.9rem; color:var(--dim);">
          <li><strong style="color:var(--text)">Hatırlatıcılar:</strong> Sabah, eksik gece ve haftalık özet bildirimlerini ayrı ayrı seç.</li>
          <li><strong style="color:var(--text)">Uyku planı:</strong> Uyanma saatini ve uyku penceresini kendi rutinine göre düzenle.</li>
          <li><strong style="color:var(--text)">Uzun vadeli görünüm:</strong> Bileşenleri açık bir indeks; biyolojik yaş veya yaşam süresi tahmini değildir.</li>
          <li><strong style="color:var(--text)">Benim bağlamım:</strong> Hastalık, seyahat, rakım ve vardiya kayıtları günlük yük önerisini sınırlar.</li>
        </ul>
      </div>
    </div>
  </section>
...
<main class="wrap"><section style="border-top:0;"><div style="display:grid; gap:24px; max-width:var(--measure);">
  ...
  <article class="panel" style="padding:24px;">
    ...
    <p>Saatte kaydettiğin setler ve günlük işaretleri, telefonda saklandığı onaylanana kadar saatteki korumalı kuyrukta tutulur. Tümünü sil işlemi, daha eski bekleyen kayıtların yeniden içe alınmasını engeller; çevrimdışı saat silme bilgisini yeniden bağlandığında alır. Apple Sağlık ve Dosyalar içindeki özgün kayıtlar bu işlemle silinmez.</p>
  ...
  <article class="panel" style="padding:24px;">
    ...
    <p>Arşiv; tercihlerini, geçici bağlam notlarını, hedeflerini ve belge asıllarını da içerir. Arşivi paylaşacağın konumu kendin seçersin. Yerel bildirimler yalnızca açtığın anahtarlara göre planlanır.</p>
  ...
  <section style="border-top:0;">
    ...
    <div style="display:grid; gap:20px; max-width:var(--measure);">
      ...
      <div class="panel" style="padding:20px;">
        <h3>Ayarlar ve tahliller nerede?</h3>
        <p>Keşfet bölümünden Ayarlar, Kan Değerleri ve Belgeler ekranlarına ulaşabilirsin. Tahlil içe aktarırken okunan her satırı doğrula. Arşiv, içe aktarma ve tümünü silme işlemleri Ayarlar → Veri bölümündedir.</p>
      </div>
      <div class="panel" style="padding:20px;">
        <h3>Saat kayıtlarım neden bekliyor?</h3>
        <p>iPhone ve Apple Watch uygulamasını aç; eşleşme ve Bluetooth bağlantısını kontrol et. Telefon kaydettiğini onaylayana kadar set kaydı saatte korunur. Aynı kaydı tekrar girmek gerekmez.</p>
      </div>
      <div class="panel" style="padding:20px;">
      ...
      <div class="panel" style="padding:20px;">
        ...
        <p style="color:var(--dim); font-size:0.92rem; line-height:1.6;">Her bireyin otonom sinir sistemi benzersizdir. Aynı HRV değeri farklı kişilerde farklı geçmişlere karşılık gelir; tek başına yorgunluk tanısı koymaz. Kişisel tabanın olgunlaşması için 14 geçerli gece örneği kullanılır. Kalibrasyon süresince öneriler düşük güven katsayısıyla verilir.</p>
      </div>
      ...
      <div class="panel" style="padding:20px;">
        ...
        <p style="color:var(--dim); font-size:0.92rem; line-height:1.6;">Bir tavsiyenin ne kadar iddialı olabileceğini arkasındaki akademik çalışmanın kanıt gücü belirler. Eğer dayanak alınan literatür (örneğin Plews 2013) tekil gün sapmalarında kesin hüküm vermiyorsa, öneri dili bu belirsizliği açıkça yansıtır.</p>
      </div>
      ...
      <div class="panel" style="padding:20px;">
        ...
        <p style="color:var(--dim); font-size:0.92rem; line-height:1.6;">Zenithium bir teşhis cihazı değildir. Tahlil modülü rapordaki referans aralığını, kayıt geçmişini ve antrenmanla zaman yakınlığını gösterir. Evrensel sporcu aralığı veya nedensellik iddia etmez. Anormal değerlerin klinik değerlendirmesi daima hekiminiz tarafından yapılmalıdır.</p>
      </div>

      <div class="panel" style="padding:20px;">
        <span class="eyebrow">Hesap ve anlatım</span>
        <h3 style="font-size:1.15rem; margin:6px 0 10px; color:var(--text);">Skorlar nasıl hesaplanıyor?</h3>
        <p style="color:var(--dim); font-size:0.92rem; line-height:1.6;">Skorlar, eşikler ve kararlar cihazdaki hesap kodundan gelir. Uygun cihazlarda Apple Foundation Models yalnızca sayısız kısa bir başlığı yeniden ifade edebilir; puanı, sayısal açıklamayı veya kararı değiştiremez. Bu özellik olmadan aynı hesaplar hazır metinlerle çalışır.</p>
      </div>
